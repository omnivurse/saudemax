/*
  # WooCommerce Member Migration Schema

  1. New Table
    - `migrated_members` - For importing WooCommerce users
  ...
  3. Schema
    - Includes WooCommerce user ID, email, plan details
    - Tracks subscription status and IUA level
*/
