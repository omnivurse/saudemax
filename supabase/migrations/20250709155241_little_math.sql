/*
  ...
  1. Purpose
    - Remove all demo/test users from the system
    - Clean up sample data from all tables
    - Ensure only legitimate production users remain
    
  2. Actions
    - Delete users with demo/test in email from auth.users
    - Remove demo data from public tables
    - Clean up sample affiliate accounts
    - Purge test member profiles
