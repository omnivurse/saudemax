-- Create migrated_members table if it doesn't exist
...
BEGIN
  ...
  RAISE NOTICE '4. Use SQL query to access active members:';
  RAISE NOTICE '   SELECT * FROM migrated_members WHERE is_active = true AND subscription_status = ''active'';';
  RAISE NOTICE '================================';
END $$;