...
async function createProductionUser() {
  try {
    ...
    const { data: userData, error: userError } = await supabase.auth.admin.createUser({
      email: 'production.affiliate@saudemax.com',
      password: 'SecureAffiliatePass123!',
      email_confirm: true,
      user_metadata: {
        full_name: 'Production Affiliate',
        role: 'affiliate'
      },
      app_metadata: {
        role: 'affiliate'
    ...
    const { data: affiliateData, error: affiliateError } = await supabase
      ...
      .insert({
        ...
        affiliate_code: 'PROD-AFFILIATE',
        referral_link: 'https://saudemax.com?ref=PROD-AFFILIATE',
        email: 'production.affiliate@saudemax.com',
        status: 'active',
        ...
        total_referrals: 0,
        total_visits: 0,
        payout_email: 'production.affiliate@saudemax.com',
    ...
    console.log('\nProduction affiliate user creation complete!');
    console.log('\nLogin credentials:');
    console.log('Email: production.affiliate@saudemax.com');
    console.log('Password: SecureAffiliatePass123!');
