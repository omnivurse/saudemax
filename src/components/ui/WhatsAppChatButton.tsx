...
export const WhatsAppChatButton: React.FC = () => {
  ...
  const phoneNumber = '18001234567'; // International format without dashes
  const message = encodeURIComponent("Hi there! I'm interested in learning more about SaudeMax plans.");
